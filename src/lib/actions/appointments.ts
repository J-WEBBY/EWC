...
export const PRAC_COLORS = [
  '#6D28D9', '#0D9488', '#D97706', '#0284C7',
  '#DC2626', '#EC4899', '#059669', '#1A1035',
];
...
const DEMO_PRACTITIONERS: PractitionerRow[] = [
  { id: 'demo-pr1', cliniko_id: 'cp1', name: 'Dr Suresh Ganata', initials: 'SG', color: '#6D28D9', is_active: true, email: null },
  { id: 'demo-pr2', cliniko_id: 'cp2', name: 'Lubna Bibi',       initials: 'LB', color: '#0D9488', is_active: true, email: null },
  { id: 'demo-pr3', cliniko_id: 'cp3', name: 'Sarah Patel',      initials: 'SP', color: '#D97706', is_active: true, email: null },
];

const DEMO_APPOINTMENT_TYPES: AppointmentTypeRow[] = [
  { id: 'at1',  cliniko_id: 'at1',  name: 'Botox — Anti-Wrinkle',             duration_minutes: 30, category: 'Aesthetics',   color: '#6D28D9' },
  { id: 'at2',  cliniko_id: 'at2',  name: 'Botox — Free Consultation',        duration_minutes: 30, category: 'Consultation', color: '#7C3AED' },
  { id: 'at3',  cliniko_id: 'at3',  name: 'Dermal Filler',                    duration_minutes: 45, category: 'Aesthetics',   color: '#7C3AED' },
  { id: 'at4',  cliniko_id: 'at4',  name: 'CoolSculpting',                    duration_minutes: 60, category: 'Body',         color: '#0284C7' },
  { id: 'at5',  cliniko_id: 'at5',  name: 'IV Therapy',                       duration_minutes: 60, category: 'Wellness',     color: '#0D9488' },
  { id: 'at6',  cliniko_id: 'at6',  name: 'Weight Management Consultation',   duration_minutes: 30, category: 'Wellness',     color: '#059669' },
  { id: 'at7',  cliniko_id: 'at7',  name: 'GP Consultation',                  duration_minutes: 20, category: 'Medical',      color: '#1A1035' },
  { id: 'at8',  cliniko_id: 'at8',  name: 'Health Screening — Full MOT',      duration_minutes: 60, category: 'Medical',      color: '#D97706' },
...
function buildDemoWeek(weekStart: Date): AppointmentRow[] {
  ...
  return [
    { id: 'da1',  cliniko_id: null, cliniko_patient_id: null, patient_name: 'Sarah Johnson', patient_email: null, patient_phone: '07801 234 567', patient_db_id: null, practitioner_name: 'Dr Suresh Ganata', practitioner_cliniko_id: 'cp1', practitioner_color: '#6D28D9', appointment_type: 'Botox — Anti-Wrinkle',           starts_at: ts(mon, 9),         ends_at: ts(mon, 9, 30),      duration_minutes: 30, status: 'arrived',  notes: 'Full forehead. Very happy with results.',  source: 'cliniko', is_new_lead: false },
    { id: 'da2',  cliniko_id: null, cliniko_patient_id: null, patient_name: 'Emma Clarke',   patient_email: null, patient_phone: null,            patient_db_id: null, practitioner_name: 'Lubna Bibi',       practitioner_cliniko_id: 'cp2', practitioner_color: '#0D9488', appointment_type: 'Dermal Filler — Lips',          starts_at: ts(mon, 10),        ends_at: ts(mon, 10, 45),     duration_minutes: 45, status: 'booked',   notes: null,                                       source: 'cliniko', is_new_lead: false },
    { id: 'da3',  cliniko_id: null, cliniko_patient_id: null, patient_name: 'Amara Osei',    patient_email: null, patient_phone: null,            patient_db_id: null, practitioner_name: 'Sarah Patel',      practitioner_cliniko_id: 'cp3', practitioner_color: '#D97706', appointment_type: 'IV Therapy — Energy Boost',     starts_at: ts(mon, 11),        ends_at: ts(mon, 12),         duration_minutes: 60, status: 'booked',   notes: 'First IV session.',                        source: 'cliniko', is_new_lead: false },
    { id: 'da4',  cliniko_id: null, cliniko_patient_id: null, patient_name: 'James Whitfield',patient_email: null,patient_phone: '07712 890 901', patient_db_id: null, practitioner_name: 'Dr Suresh Ganata', practitioner_cliniko_id: 'cp1', practitioner_color: '#6D28D9', appointment_type: 'Botox — Free Consultation',    starts_at: ts(mon, 14),        ends_at: ts(mon, 14, 30),     duration_minutes: 30, status: 'booked',   notes: 'New enquiry via Komal. First visit.',      source: 'komal',   is_new_lead: true  },
    { id: 'da5',  cliniko_id: null, cliniko_patient_id: null, patient_name: 'Lisa Pearce',   patient_email: null, patient_phone: null,            patient_db_id: null, practitioner_name: 'Lubna Bibi',       practitioner_cliniko_id: 'cp2', practitioner_color: '#0D9488', appointment_type: 'Profhilo',                      starts_at: ts(add(mon,1), 9,30),ends_at: ts(add(mon,1),10),   duration_minutes: 30, status: 'booked',   notes: null,                                       source: 'cliniko', is_new_lead: false },
    { id: 'da6',  cliniko_id: null, cliniko_patient_id: null, patient_name: 'Marcus Johnson', patient_email: null,patient_phone: null,            patient_db_id: null, practitioner_name: 'Dr Suresh Ganata', practitioner_cliniko_id: 'cp1', practitioner_color: '#6D28D9', appointment_type: 'GP Consultation',               starts_at: ts(add(mon,1),10,30),ends_at: ts(add(mon,1),10,50),duration_minutes: 20, status: 'booked',   notes: null,                                       source: 'cliniko', is_new_lead: false },
    { id: 'da7',  cliniko_id: null, cliniko_patient_id: null, patient_name: 'Priya Verma',   patient_email: null, patient_phone: null,            patient_db_id: null, practitioner_name: 'Sarah Patel',      practitioner_cliniko_id: 'cp3', practitioner_color: '#D97706', appointment_type: 'Weight Management Consultation',starts_at: ts(add(mon,1),14),   ends_at: ts(add(mon,1),14,30),duration_minutes: 30, status: 'booked',   notes: 'Referred by friend.',                      source: 'cliniko', is_new_lead: false },
    { id: 'da8',  cliniko_id: null, cliniko_patient_id: null, patient_name: 'Helen Morris',  patient_email: null, patient_phone: null,            patient_db_id: null, practitioner_name: 'Dr Suresh Ganata', practitioner_cliniko_id: 'cp1', practitioner_color: '#6D28D9', appointment_type: 'CoolSculpting — Abdomen',       starts_at: ts(add(mon,2),10),   ends_at: ts(add(mon,2),11),   duration_minutes: 60, status: 'booked',   notes: 'Second session.',                          source: 'cliniko', is_new_lead: false },
    { id: 'da9',  cliniko_id: null, cliniko_patient_id: null, patient_name: 'David Chen',    patient_email: null, patient_phone: null,            patient_db_id: null, practitioner_name: 'Lubna Bibi',       practitioner_cliniko_id: 'cp2', practitioner_color: '#0D9488', appointment_type: 'Botox — Anti-Wrinkle',           starts_at: ts(add(mon,2),11,30),ends_at: ts(add(mon,2),12),   duration_minutes: 30, status: 'booked',   notes: null,                                       source: 'cliniko', is_new_lead: false },
    { id: 'da10', cliniko_id: null, cliniko_patient_id: null, patient_name: 'Zara Ahmed',    patient_email: null, patient_phone: null,            patient_db_id: null, practitioner_name: 'Sarah Patel',      practitioner_cliniko_id: 'cp3', practitioner_color: '#D97706', appointment_type: 'IV Therapy — Vitamin C',        starts_at: ts(add(mon,3),9),    ends_at: ts(add(mon,3),10),   duration_minutes: 60, status: 'booked',   notes: null,                                       source: 'cliniko', is_new_lead: false },
    { id: 'da11', cliniko_id: null, cliniko_patient_id: null, patient_name: 'Tom Bradley',   patient_email: null, patient_phone: null,            patient_db_id: null, practitioner_name: 'Dr Suresh Ganata', practitioner_cliniko_id: 'cp1', practitioner_color: '#6D28D9', appointment_type: 'Health Screening — Full MOT',   starts_at: ts(add(mon,3),11),   ends_at: ts(add(mon,3),12),   duration_minutes: 60, status: 'booked',   notes: null,                                       source: 'cliniko', is_new_lead: false },
    { id: 'da12', cliniko_id: null, cliniko_patient_id: null, patient_name: 'Fatima Hassan', patient_email: null, patient_phone: null,            patient_db_id: null, practitioner_name: 'Lubna Bibi',       practitioner_cliniko_id: 'cp2', practitioner_color: '#0D9488', appointment_type: 'Dermal Filler — Cheeks',        starts_at: ts(add(mon,4),10),   ends_at: ts(add(mon,4),10,45),duration_minutes: 45, status: 'booked',   notes: null,                                       source: 'cliniko', is_new_lead: false },
    { id: 'da13', cliniko_id: null, cliniko_patient_id: null, patient_name: 'Sophie Turner', patient_email: null, patient_phone: null,            patient_db_id: null, practitioner_name: 'Dr Suresh Ganata', practitioner_cliniko_id: 'cp1', practitioner_color: '#6D28D9', appointment_type: 'Botox — Anti-Wrinkle',           starts_at: ts(add(mon,4),14),   ends_at: ts(add(mon,4),14,30),duration_minutes: 30, status: 'booked',   notes: 'Via Komal — returning patient.',           source: 'komal',   is_new_lead: false },
  ];
}
...
export async function getWeekAppointments(weekStart: string): Promise<{
  ...
  try {
    ...
    const rows: AppointmentRow[] = appts.map((a: any) => {
      ...
      const color = a.cliniko_practitioner_id ? (colorMap.get(a.cliniko_practitioner_id) ?? '#6E6688') : '#6E6688';
      return {
        id:                     a.id,
